...
import com.xy.core.util.FileUtil;
import com.xy.generator.engine.SimpleTemplateEngine;
import com.xy.generator.engine.base.XyTemplateEngine;
import com.xy.generator.engine.config.ContextConfig;
import com.xy.generator.engine.config.SqlConfig;
...
public abstract class AbstractGeneratorConfig {
    ...
    public void doAdiGeneration() {
        XyTemplateEngine XyTemplateEngine = new SimpleTemplateEngine();
        XyTemplateEngine.setContextConfig(contextConfig);
        sqlConfig.setConnection(dataSourceConfig.getConn());
        XyTemplateEngine.setSqlConfig(sqlConfig);
        XyTemplateEngine.setTableInfo(tableInfo);
        XyTemplateEngine.start();
    }
}
