package com.xy.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "xyTemplate/advanced";
    ...
    private String proPackage = "com.xy.admin";
    private String coreBasePackage = "com.xy.core";
    private String modelPackageName = "com.xy.admin.common.persistence.model";        //model的包名
    private String modelMapperPackageName = "com.xy.admin.common.persistence.dao";  //model的dao
