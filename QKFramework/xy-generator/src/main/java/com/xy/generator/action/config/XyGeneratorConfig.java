package com.xy.generator.action.config;
 ...
 */
public class XyGeneratorConfig extends AbstractGeneratorConfig {

    protected void globalConfig() {
        globalConfig.setOutputDir("D:\\ideaSpace\\xy\\xy-admin\\src\\main\\java");//写自己项目的绝对路径,注意具体到java目录
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.xy.admin.common.persistence.model");
        packageConfig.setMapper("com.xy.admin.common.persistence.dao");
        packageConfig.setXml("com.xy.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.xy.admin");
        contextConfig.setCoreBasePackage("com.xy.core");
        contextConfig.setBizChName("字典管理");
        contextConfig.setBizEnName("sysDict");
        contextConfig.setModuleName("system");
        contextConfig.setProjectPath("D:\\ideaSpace\\xy\\xy-admin");//写自己项目的绝对路径
