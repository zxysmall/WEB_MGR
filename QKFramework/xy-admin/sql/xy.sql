...
DROP DATABASE IF EXISTS xy_flowable;
CREATE DATABASE IF NOT EXISTS xy_flowable DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

DROP DATABASE IF EXISTS xy;
CREATE DATABASE IF NOT EXISTS xy DEFAULT CHARSET utf8 COLLATE utf8_general_ci;
...
CREATE TABLE `sys_dict` (
  ...
  `tips` varchar(255) DEFAULT NULL COMMENT '提示',
  `selected`  int(1) NULL DEFAULT 0 COMMENT '是否选中',
  PRIMARY KEY (`id`)
...
-- Records of sys_dict
-- ----------------------------
INSERT INTO `sys_dict` VALUES (16, 0, 0, '状态', NULL, 0);
INSERT INTO `sys_dict` VALUES (17, 1, 16, '启用', NULL, 0);
INSERT INTO `sys_dict` VALUES (18, 2, 16, '禁用', NULL, 0);
INSERT INTO `sys_dict` VALUES (29, 0, 0, '性别', NULL, 0);
INSERT INTO `sys_dict` VALUES (30, 1, 29, '男', NULL, 0);
INSERT INTO `sys_dict` VALUES (31, 2, 29, '女', NULL, 0);
INSERT INTO `sys_dict` VALUES (35, 0, 0, '账号状态', NULL, 0);
INSERT INTO `sys_dict` VALUES (36, 1, 35, '启用', NULL, 0);
INSERT INTO `sys_dict` VALUES (37, 2, 35, '冻结', NULL, 0);
INSERT INTO `sys_dict` VALUES (38, 3, 35, '已删除', NULL, 0);
INSERT INTO `sys_dict` VALUES (39, 0, 0, '数据权限', NULL, 0);
INSERT INTO `sys_dict` VALUES (40, 1, 39, '全部', NULL, 0);
INSERT INTO `sys_dict` VALUES (41, 2, 39, '分管组织/部门', NULL, 0);
INSERT INTO `sys_dict` VALUES (42, 3, 39, '所属组织/部门', NULL, 0);
INSERT INTO `sys_dict` VALUES (43, 4, 39, '所属角色', NULL, 0);
INSERT INTO `sys_dict` VALUES (44, 5, 39, '个人', NULL, 1);
INSERT INTO `sys_dict` VALUES (50, 0, 0, '出票状态', NULL, 0);
INSERT INTO `sys_dict` VALUES (51, 1, 50, '全部', NULL, 1);
INSERT INTO `sys_dict` VALUES (52, 2, 50, '已出', NULL, 0);
INSERT INTO `sys_dict` VALUES (53, 3, 50, '未出', NULL, 0);
...
INSERT INTO `sys_menu` VALUES (118, 'role_setAuthority', 'role', '[0],[system],[role],', '功能权限配置', '', '/role/setAuthority', 4, 3, 0, NULL, 1, 0);
...
INSERT INTO `sys_menu` VALUES (171, 'busi', '0', '[0],', '业务管理', 'fa-ship', '#', 4, 1, 1, NULL, 1, NULL);
INSERT INTO `sys_menu` VALUES (172, 'order', 'busi', '[0],[busi],', '订单管理', '', '/ticketOrder', 1, 2, 1, NULL, 1, NULL);
INSERT INTO `sys_menu` VALUES (173, 'order_add', 'order', '[0],[busi],[order],', '添加订单', '', '/ticketOrder/add', 1, 3, 0, NULL, 1, NULL);
INSERT INTO `sys_menu` VALUES (174, 'order_update', 'order', '[0],[busi],[order],', '修改订单', '', '/ticketOrder/update', 2, 3, 0, NULL, 1, NULL);
INSERT INTO `sys_menu` VALUES (175, 'order_delete', 'order', '[0],[busi],[order],', '删除订单', '', '/ticketOrder/delete', 3, 3, 0, NULL, 1, NULL);
INSERT INTO `sys_menu` VALUES (176, 'role_setDataAuthority', 'role', '[0],[system],[role],', '数据权限配置', '', '/role/setDataAuthority', 5, 3, 0, NULL, 1, NULL);
INSERT INTO `sys_menu` VALUES (177, 'to_role_data_assign', 'role', '[0],[system],[role],', '角色数据管控跳转', '', '/role/role_data_assign', 6, 3, 0, NULL, 1, NULL);
INSERT INTO `sys_menu` VALUES (178, 'order_outTicket', 'order', '[0],[busi],[order],', '出票订单', '', '/ticketOrder/outTicket', 4, 3, 0, NULL, 1, NULL);
INSERT INTO `sys_menu` VALUES (179, 'payFlow', 'busi', '[0],[busi],', '支付流程', '', '/payFlow', 2, 2, 1, NULL, 1, NULL);
INSERT INTO `sys_menu` VALUES (180, 'payFlow_add', 'payFlow', '[0],[busi],[payFlow],', '添加支付流程', '', '/payFlow/add', 0, 3, 0, NULL, 1, NULL);
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('6', '世界', '10', '欢迎使用Xy管理系统', '2017-01-11 08:53:20', '1');
