 ...
 */
public class XyDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public XyDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public XyDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
