...
import com.xy.common.constant.dictmap.MenuDict;
...
import com.xy.core.support.BeanKit;
import com.xy.core.util.ToolUtil;
import com.xy.modular.system.dao.MenuDao;
import com.xy.modular.system.service.IMenuService;
import com.xy.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new XyException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new XyException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
