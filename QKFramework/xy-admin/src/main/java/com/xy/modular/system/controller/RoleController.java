...
import com.xy.common.constant.dictmap.RoleDict;
...
import com.xy.core.cache.CacheKit;
...
import com.xy.modular.system.dao.RoleDao;
import com.xy.modular.system.service.IRoleService;
import com.xy.modular.system.warpper.RoleWarpper;
...
public class RoleController extends BaseController {
     ...
     */
    @Permission
    @RequestMapping(value = "/role_data_assign/{roleId}")
    public String roleDataAssign(@PathVariable("roleId") Integer roleId, Model model) {
    	if (ToolUtil.isEmpty(roleId)) {
    		throw new XyException(BizExceptionEnum.REQUEST_NULL);
    	}
    	model.addAttribute("roleId", roleId);
    	model.addAttribute("roleName", ConstantFactory.me().getSingleRoleName(roleId));
    	return PREFIX + "/role_data_assign.html";
    }
    ...
    public Tip setDataAuthority(@RequestParam("roleId") Integer roleId, @RequestParam("ids") String ids
    	...
    	this.roleService.setDataAuthority(roleId,dataType, ids);
    	return SUCCESS_TIP;
    }
