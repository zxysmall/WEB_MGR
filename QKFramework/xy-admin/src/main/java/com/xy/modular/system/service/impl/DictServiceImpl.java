...
import static com.xy.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if(dicts != null && dicts.size() > 0){
            throw new XyException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new XyException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
