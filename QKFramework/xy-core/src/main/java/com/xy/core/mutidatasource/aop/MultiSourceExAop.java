package com.xy.core.mutidatasource.aop;

import com.xy.core.mutidatasource.DataSourceContextHolder;
import com.xy.core.mutidatasource.annotion.DataSource;
...
public class MultiSourceExAop implements Ordered {
    ...
    @Pointcut(value = "@annotation(com.xy.core.mutidatasource.annotion.DataSource)")
    private void cut() {
